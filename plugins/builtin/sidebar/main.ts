...
const RESERVED = new Set([
  // `a` is deliberately not here any more. It was this panel's own key for the archive; the archive
  // is somebody else's panel now, and the key that opens it arrives the way any third party's would
  // — which is the point of the mechanism and would have been a lie while we kept the letter.
  "j", "k", "q", "f", "J", "K", "r", "x", "X", "n", "o", "y", "?", " ",
