...
Version 0 is a draft and the wire types may change without a compatibility story. When they settle,
this document and the generated types move to a repository of their own so a non-neosh
implementation is not vendoring an editor to get a schema.
